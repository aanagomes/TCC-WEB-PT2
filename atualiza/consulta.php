        ...
        <div class="escolha"> Selecione os filtros:</div>
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="col-md-3">
                    <div class="form-group">
                        <label for="grau"><h5>Área de atuação</h5></label>
                            <select class="form-control" name="graub" id="graub">
                                <option value="">Área de atuação</option>
                                <option value="Limpeza de ruas">Limpeza de ruas</option>
                                <option value="Oficina">Oficina</option>
                                <option value="Carpinagem Manual">Carpinagem Manual</option>
                                <option value="Carpinagem Máquina">Carpinagem Máquina</option>
